  ...
  return (
    ...
    >
      ...
      <Card className="w-full max-w-5xl">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-gray-900">Student Information</CardTitle>
          <CardDescription className="text-gray-600">Please fill out all the fields below</CardDescription>
        </CardHeader>
        <CardContent>
          <form 
          className="space-y-4"
          ...
          >
            ...
            <div className="space-y-2">
              ...
              onChange={ (e: any) => setUserDetails({...userDetails, fullName: e.target.value}) }
              placeholder="John Doe" className="border-gray-300 focus:border-gray-500" />
            </div>
            ...
            <div className="space-y-2">
              ...
              onChange={ (e: any) => setUserDetails({...userDetails, rollNumber: e.target.value}) }
              placeholder="12345" className="border-gray-300 focus:border-gray-500" />
            </div>
            ...
            <div className="space-y-2">
              ...
              onChange={ (e: any) => setUserDetails({...userDetails, whatsappNumber: e.target.value}) }
              placeholder="+91 98765 43210" className="border-gray-300 focus:border-gray-500" />
            </div>
            ...
            <div className="space-y-2">
              ...
              type="email" placeholder="johndoe@example.com" className="border-gray-300 focus:border-gray-500" />
            </div>

            <div className="space-y-2">
              <Label htmlFor="course" className="text-gray-700">Course Enrolled</Label>
              <Input id="course" 
              value={userDetails.course}
              onChange={ (e: any) => setUserDetails({...userDetails, course: e.target.value}) }
              placeholder="BCA" className="border-gray-300 focus:border-gray-500" />
            </div>
